...
export default function EditHabitTrackerForm({ habitId }: { habitId: number }) {
  ...
  useEffect(() => {
    // Fetch the habit data from the API
  ...
  return (
    <div>
      <h2 className="mb-6 text-xl font-light text-gray-700">Edit Habit</h2>
      {errors.length > 0 && (
